...
public class Pessoa {
    ...
    public void setNome(String nome) {
        if (nome.matches("[a-zA-Z ]+") && !nome.trim().isEmpty()) {
            this.nome = nome;
        } 
    }
    ...
    public void setNaturalidade(String naturalidade) {
        if (naturalidade != null && naturalidade.matches("[a-zA-Z ]*")) {
    ...
    public String toString() {
        return "Pessoa [" +
                ...
                ", dataNascimento=" + (dataNascimento != null ? dataNascimento.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) : "Não informada") +
                ", genero=" + genero +
                ", altura=" + altura +
                ", peso=" + peso +
                ", renda=" + renda +

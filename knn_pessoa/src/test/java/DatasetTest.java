...
public class DatasetTest {
    ...
    void testGetAll() {
        assertEquals(0, dataset.size(), "Vetor de pessoas deve estar vazio inicialmente");
        dataset.addPessoa(pessoa2);
        Pessoa[] pessoas2 = dataset.getAll();
        assertEquals(1000, pessoas2.length, "Tamanho do vetor pessoas está incorreto");
        assertEquals(pessoa2, pessoas2[0], "A pessoa adicionada deve ser igual à recuperada.");
    }
    ...
    void testRemoveAll() {
        ...
        dataset.removeAll();
        assertEquals(0, dataset.size(), "O vetor deve estar vazio após chamar removeAll.");
    }
